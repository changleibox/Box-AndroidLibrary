...
import net.box.app.library.widget.IPhotoViewAttacher.OnMatrixChangedListener;
...
public class IPhotoView extends android.support.v7.widget.AppCompatImageView implements IPhotoViewImp {
	...
	public IPhotoView(Context context, AttributeSet attr) {
		this(context, attr, 0);
	}
	
	public IPhotoView(Context context, AttributeSet attr, int defStyle) {
		super(context, attr, defStyle);
		super.setScaleType(ScaleType.MATRIX);
		mAttacher = new IPhotoViewAttacher(this);
