 ...
 * 此功能的时候，需要将该Activity的顶层布局设置为SildingLayout，
 ...
 * 2015年1月8日
 */
public class ISildingLayout extends RelativeLayout implements OnTouchListener {
	/**
	...
	public ISildingLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ISildingLayout(Context context, AttributeSet attrs, int defStyle) {
