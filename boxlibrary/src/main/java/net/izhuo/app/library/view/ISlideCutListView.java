 ...
 * 
 */
public class ISlideCutListView extends ListView {
	/**
	...
	public ISlideCutListView(Context context) {
		this(context, null);
	}

	public ISlideCutListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	@SuppressWarnings("deprecation")
	public ISlideCutListView(Context context, AttributeSet attrs, int defStyle) {
