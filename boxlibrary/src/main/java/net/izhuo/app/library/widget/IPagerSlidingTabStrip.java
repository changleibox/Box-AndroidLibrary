...
public class IPagerSlidingTabStrip extends HorizontalScrollView {
	...
	public IPagerSlidingTabStrip(Context context) {
		this(context, null);
	}

	public IPagerSlidingTabStrip(Context context, AttributeSet attrs) {
	...
	public IPagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		a = context.obtainStyledAttributes(attrs,
				R.styleable.BoxPagerSlidingTabStrip);

		indicatorColor = a.getColor(
				R.styleable.BoxPagerSlidingTabStrip_pstsIndicatorColor,
				indicatorColor);
		underlineColor = a.getColor(
				R.styleable.BoxPagerSlidingTabStrip_pstsUnderlineColor,
				underlineColor);
		dividerColor = a
				.getColor(R.styleable.BoxPagerSlidingTabStrip_pstsDividerColor,
						dividerColor);
		indicatorHeight = a.getDimensionPixelSize(
				R.styleable.BoxPagerSlidingTabStrip_pstsIndicatorHeight,
				indicatorHeight);
		underlineHeight = a.getDimensionPixelSize(
				R.styleable.BoxPagerSlidingTabStrip_pstsUnderlineHeight,
				underlineHeight);
		dividerPadding = a.getDimensionPixelSize(
				R.styleable.BoxPagerSlidingTabStrip_pstsDividerPadding,
				dividerPadding);
		tabPadding = a.getDimensionPixelSize(
				R.styleable.BoxPagerSlidingTabStrip_pstsTabPaddingLeftRight,
				tabPadding);
		tabBackgroundResId = a.getResourceId(
				R.styleable.BoxPagerSlidingTabStrip_pstsTabBackground,
				tabBackgroundResId);
		shouldExpand = a
				.getBoolean(R.styleable.BoxPagerSlidingTabStrip_pstsShouldExpand,
						shouldExpand);
		scrollOffset = a
				.getDimensionPixelSize(
						R.styleable.BoxPagerSlidingTabStrip_pstsScrollOffset,
						scrollOffset);
		textAllCaps = a.getBoolean(
				R.styleable.BoxPagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
	...
	public void setOnPagerChangeListener(OnPageChangeListener changeListener) {
		this.mPageChangeListener = changeListener;
	}

	/**
	 * @return the isClickTab
	 */
	...
	/**
	 * @param isClickTab
	 *            the isClickTab to set
	 */
	public void setClickTab(boolean isClickTab) {
		this.isClickTab = isClickTab;
	}

	public interface OnItemClickListener {
		public void onItemClick(int position, View tab);
	}
			...
			public void onClick(View v) {
				if (isClickTab()) {
					if (mClickListener != null) {
						mClickListener.onItemClick(position, tab);
					}
