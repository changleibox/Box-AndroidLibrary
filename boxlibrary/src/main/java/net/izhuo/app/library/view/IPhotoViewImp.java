...
public interface IPhotoViewImp {
    /**
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(IPhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(IPhotoViewAttacher.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(IPhotoViewAttacher.OnViewTapListener listener);
