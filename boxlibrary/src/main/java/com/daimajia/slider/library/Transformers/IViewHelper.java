...
public final class IViewHelper {
	private IViewHelper() {
	}

	public static float getAlpha(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view).getAlpha()
				: Honeycomb.getAlpha(view);
	}

	public static void setAlpha(View view, float alpha) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setAlpha(alpha);
		} else {
	...
	public static float getPivotX(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view).getPivotX()
				: Honeycomb.getPivotX(view);
	}

	public static void setPivotX(View view, float pivotX) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setPivotX(pivotX);
		} else {
	...
	public static float getPivotY(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view).getPivotY()
				: Honeycomb.getPivotY(view);
	}

	public static void setPivotY(View view, float pivotY) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setPivotY(pivotY);
		} else {
	...
	public static float getRotation(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view)
				.getRotation() : Honeycomb.getRotation(view);
	}

	public static void setRotation(View view, float rotation) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setRotation(rotation);
		} else {
	...
	public static void setRotationX(View view, float rotationX) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setRotationX(rotationX);
		} else {
	...
	public static void setRotationY(View view, float rotationY) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setRotationY(rotationY);
		} else {
	...
	public static float getScaleX(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view).getScaleX()
				: Honeycomb.getScaleX(view);
	}

	public static void setScaleX(View view, float scaleX) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setScaleX(scaleX);
		} else {
	...
	public static float getScaleY(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view).getScaleY()
				: Honeycomb.getScaleY(view);
	}

	public static void setScaleY(View view, float scaleY) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setScaleY(scaleY);
		} else {
	...
	public static void setScrollX(View view, int scrollX) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setScrollX(scrollX);
		} else {
	...
	public static void setScrollY(View view, int scrollY) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setScrollY(scrollY);
		} else {
	...
	public static void setTranslationX(View view, float translationX) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setTranslationX(translationX);
		} else {
	...
	public static void setTranslationY(View view, float translationY) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setTranslationY(translationY);
		} else {
	...
	public static float getX(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view).getX()
				: Honeycomb.getX(view);
	}

	public static void setX(View view, float x) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setX(x);
		} else {
	...
	public static float getY(View view) {
		return IAnimatorProxy.NEEDS_PROXY ? IAnimatorProxy.wrap(view).getY()
				: Honeycomb.getY(view);
	}

	public static void setY(View view, float y) {
		if (IAnimatorProxy.NEEDS_PROXY) {
			IAnimatorProxy.wrap(view).setY(y);
		} else {
