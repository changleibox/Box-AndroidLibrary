 ...
 */
public final class IAnimatorProxy extends Animation {
	...
	private static final WeakHashMap<View, IAnimatorProxy> PROXIES = new WeakHashMap<View, IAnimatorProxy>();
	 ...
	 */
	public static IAnimatorProxy wrap(View view) {
		IAnimatorProxy proxy = PROXIES.get(view);
		// This checks if the proxy already exists and whether it still is the
		// animation of the given view
		if (proxy == null || proxy != view.getAnimation()) {
			proxy = new IAnimatorProxy(view);
	...
	private IAnimatorProxy(View view) {
