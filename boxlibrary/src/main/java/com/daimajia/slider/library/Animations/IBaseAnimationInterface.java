 ...
 * {@link com.daimajia.slider.library.Tricks.IViewPagerEx} animation (PagerTransformer) starts or ends.
 *
 *
 ...
 *
 * You can see a demo class {@link IDescriptionAnimation},
 * this class gives the description text an animation.
 */
public interface IBaseAnimationInterface {
